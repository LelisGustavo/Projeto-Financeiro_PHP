...
class EmpresaDAO extends Conexao
{
    ...
    public function AlterarEmpresa($id_empresa, $nome_empresa, $telefone_empresa, $endereco_empresa)
    {
    ...
    public function FiltrarEmpresa($filtrar_nome_empresa)
    {
        $conexao = parent::retornarConexao();
        ...
        $sql->bindValue(1, UtilDAO::CodigoLogado());
        $sql->bindValue(2, '%' . $filtrar_nome_empresa . '%');
    ...
    public function FiltrarTelefone($filtrar_telefone_empresa) 
    {
        $conexao = parent::retornarConexao();
        ...
        $sql->bindValue(1, UtilDAO::CodigoLogado());
        $sql->bindValue(2, '%' . $filtrar_telefone_empresa . '%');
    ...
    public function FiltrarEndereco($filtrar_endereco_empresa) 
    {
        $conexao = parent::retornarConexao();
        ...
        $sql->bindValue(1, UtilDAO::CodigoLogado());
        $sql->bindValue(2, '%' . $filtrar_endereco_empresa . '%');
