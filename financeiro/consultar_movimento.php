            ...
            <div id="page-inner">
                ...
                <div class="col-md-6">
                    <div class="form-group" id="divMovimento_1">
                        ...
                        <input type="date" class="form-control" placeholder="Coloque a data do movimento" id="data_inicial"/>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group" id="divMovimento_2">
                        ...
                        <input type="date" class="form-control" placeholder="Coloque a data do movimento" id="data_final"/>
                    </div>
                </div>
                <center>
